...
//
// Author         : $Author: Len $
// Date           : $Date: 12/08/02 12:13 $
//
// Notes          : 
//
// Modifications  :
//
// $Log: /Web Articles/SocketServers/PacketEchoServer/PacketEchoServer/SocketServer.cpp $
// 
// 4     12/08/02 12:13 Len
// Handle new connection reset and connection error events.
// 
// 3     15/07/02 13:38 Len
// Updated to provide an example for the article on read and write
// sequence numbers.
// 
// 2     9/07/02 18:34 Len
...
CSocketServer::CSocketServer(
   ...
   :  JetByteTools::Win32::CSocketServer(addressToListenOn, portToListenOn, maxFreeSockets, maxFreeBuffers, bufferSize, numThreads, useSequenceNumbers),
