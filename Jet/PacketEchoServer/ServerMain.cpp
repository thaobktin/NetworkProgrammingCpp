...
//
// Author         : $Author: Len $
// Date           : $Date: 10/08/02 13:38 $
//
// Notes          : 
//
// Modifications  :
//
// $Log: /Web Articles/SocketServers/PacketEchoServer/PacketEchoServer/ServerMain.cpp $
// 
// 4     10/08/02 13:38 Len
// Lint issues.
// 
...
int main(int /*argc*/, char * /*argv[ ]*/)
{
   try
   {
      CSocketServer server1(
         ...
         1024,                         // buffer size 
         0,                            // num threads (automatically worked out)
